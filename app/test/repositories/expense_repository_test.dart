...
void main() {
  ...
  group('ExpenseRepository - CRUD Operations', () {
    ...
    test('getAllExpenses - should return empty list when no expenses exist',
        () async {
      // Act
    ...
    test('getExpensesByProperty - should return empty list when no expenses',
        () async {
      // Arrange
      final propertyIds = await seedTestProperties(db);
    ...
    test('getExpensesByProperty - should return only expenses for property',
        () async {
      // Arrange
      final propertyIds = await seedTestProperties(db);
      await repository.addExpense(
  ...
  group('ExpenseRepository - Business Logic', () {
    test('calculateYearlyExpenses - should return 0 when no expenses exist',
        () async {
      // Act
    ...
    test('calculateYearlyExpenses - should sum expenses for given year',
        () async {
      // Arrange
      final propertyIds = await seedTestProperties(db);
    ...
    test('calculateYearlyExpenses - should handle year boundaries correctly',
        () async {
      // Arrange
      final propertyIds = await seedTestProperties(db);
    ...
    test('calculateProfitLoss - should return negative when expenses exceed income',
        () async {
      // Arrange
      final propertyIds = await seedTestProperties(db);
    ...
    test('calculateProfitLoss - should return positive when income exceeds expenses',
        () async {
      // Arrange
      final propertyIds = await seedTestProperties(db);
      final tenantIds = await seedTestTenants(db);
    ...
    test('calculateProfitLoss - should only count rent and lateFee payments',
        () async {
      // Arrange
      final propertyIds = await seedTestProperties(db);
      final tenantIds = await seedTestTenants(db);
    ...
    test('calculateProfitLoss - should return 0 when no income or expenses',
        () async {
      // Act
      final profitLoss = await repository.calculateProfitLoss(2025);
